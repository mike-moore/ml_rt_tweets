...
class TestNaiveBayesTwitter(TestCase):

    def test_predict_tweet_sentiment(self):
        from NaiveBayesTwitter import predict_tweet_sentiment
        sentiment = predict_tweet_sentiment("I'm happy you're here!")
        self.assertAlmostEqual(0.68, sentiment, 1)
        sentiment = predict_tweet_sentiment("I'm pissed off!")
        self.assertAlmostEqual(0.20, sentiment, 1)
        return
